const providers = [
    ...
    // 品牌素材製作 (6) - Excel order: Click Visual, Odin, 奕昕國際, 靈志科技, 秩宇Wiser, 全球賣
    {
        name: "Couger Yang",
...
function createProviderCard(provider) {
    ...
    card.innerHTML = `
        ...
        <div class="company-intro">
            ...
            ${qrCodePath ? `<br><br><img src="${qrCodePath}" alt="QR Code" class="qr-code" onclick="openImageModal('${qrCodePath}')" style="cursor: pointer;">` : ''}
        </div>
        ` : ''}
    `;
...
// Add remaining 18 providers to complete all 24
providers.push(
    // 商標申請 (2)
    {
        name: "Vicky Lee",
    ...
    // 代營運 (3) - Excel order: Odin, DRS, 全球賣
    {
        name: "Sue",
        company: "Odin 跨境電商運營",
        service_type: "代營運",
